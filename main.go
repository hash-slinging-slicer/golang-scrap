...
func fetchHTML(url string, cookieString string) (map[string][]string, error) {
	...
	cookiesString := "sb=K90YZSDwtyztrt3t3Ikb3nAz; datr=K90YZZbuu9xmmkNpoN2WSGpX; c_user=100009705467505; ps_n=0; ps_l=0; fbl_cs=AhDIMta36cB1%2B2jleeEuhfmbGDgzbkxaQlRYR2EyTGxQK05qT3ZsbnRLSA; fbl_ci=1320958615211278; m_page_voice=100009705467505; i_user=61550559231213; dpr=2.0000000298023224; wd=1778x316; xs=19%3ANlaiS5MlKQItAw%3A2%3A1707962674%3A-1%3A11050%3A%3AAcV-XrTTWQjX_HhW575i2wcqvXmjQn-DafpILkEq3Q; fr=1OAfGIFa2rvfES9nS.AWVFlOYr40LGGCqxXHJZyOuEAas.BlzcZP..AAA.0.0.BlzcZP.AWViFRlTV_4; locale=en_US; fbl_st=101634769%3BT%3A28466407; wl_cbv=v2%3Bclient_version%3A2408%3Btimestamp%3A1707984470"

	// Split the string into individual cookies
	cookiesSlice := strings.Split(cookiesString, "; ")
